...
paper's oracle loop is evaluated on.
    ...
    uv run python scripts/impossibility/impossibility_report.py                      # table
    uv run python scripts/impossibility/impossibility_report.py --budget-curve       # + MAttr vs brute force
"""
import argparse
import json
import re
