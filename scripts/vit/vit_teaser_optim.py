...
outright (`scripts/sva/launch/submit_adam_eps_followup.sh`: at eps=1e-8 the update degenerates to
...
resolved arguments). `plots/plot_vit_optim.py` reads them.
    ...
    sbatch -J vito42 scripts/vit/launch/vit_optim.sbatch --seed 42 --out results/vit_optim/seed42
"""
import argparse
import json
import sys
