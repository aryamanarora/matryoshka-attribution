...
# possible no-op.
#
#   bash scripts/submit_edge_sgd_lr3.sh            # submit
#   DRYRUN=1 bash scripts/submit_edge_sgd_lr3.sh   # preview
#   ONLY=validation bash scripts/submit_edge_sgd_lr3.sh   # one split
set -u
...
$py scripts/eval_mib_edge.py --model $model --task $task --steps 5000 --k-schedule log \
