...
#
#   bash scripts/sva/launch/submit_sva_node_pruning.sh            # submit missing cells, s=0.9
#   S=0.8 bash scripts/sva/launch/submit_sva_node_pruning.sh      # a different budget
#   DRY=1 bash scripts/sva/launch/submit_sva_node_pruning.sh      # print, submit nothing
