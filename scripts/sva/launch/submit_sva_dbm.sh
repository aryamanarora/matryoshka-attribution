...
#
#   bash scripts/sva/launch/submit_sva_dbm.sh                 # submit missing cells at the recipe above
#   LR=0.1 L1=6.0 bash scripts/sva/launch/submit_sva_dbm.sh   # a different point (its own tag + files)
#   L1=0 bash scripts/sva/launch/submit_sva_dbm.sh            # the unpenalised pyvene-library recipe
#   DRY=1 bash scripts/sva/launch/submit_sva_dbm.sh           # print, submit nothing
