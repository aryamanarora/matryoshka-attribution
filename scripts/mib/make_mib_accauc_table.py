...
# The MIB fork's results tree (deps/MIB-circuit-track/results on the canonical checkout, the
# legacy cluster A path elsewhere). Was hardcoded to cluster A until 2026-09-16, which on cluster B made every
...
EVALMIB_ACC = {"htklog_lr_0.05", "topklog_lr_0.05", "mib_node_topk_uniform_lr05",
               ...
               "mib_node_topkid_uniform_frozen"}
