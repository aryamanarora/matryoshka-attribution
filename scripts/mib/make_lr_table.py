...
hold all tasks.
Run from repo root:  uv run python scripts/mib/make_lr_table.py
"""
import json
import pickle
...
from matryoshka_attribution.deps import mib_results_dir   # deps/MIB-circuit-track/results, else the cluster-A path
