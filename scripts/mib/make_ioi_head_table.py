...
Run:  uv run python scripts/mib/make_ioi_head_table.py  ->  paper/tabs/ioi_top_nodes.tex
...
def main():
    ...
    L = [r"% Requires \usepackage{booktabs,longtable,colortbl,array}; \input at top level "
         ...
         r"% Generated by scripts/mib/make_ioi_head_table.py -- do not edit by hand.",
