...
OUR_METHODS = [
    ...
    # Two backward passes: topk_identity (soft fwd, identity bwd = IG along the mask path) is the
    # "$-$ learning" row; the soft top-k Jacobian (sigma' + centring) is "$-$ learning, soft bwd".
    ("$-$ learning", "mib_node_topkid_uniform_frozen", "node", "uniform"),
    ("$-$ learning, soft bwd", "mib_node_topk_uniform_frozen", "node", "uniform"),
    ("$-$ learning", "mib_node_topkid_log_frozen", "node", "ours"),
    ("$-$ learning, soft bwd", "mib_node_topk_log_frozen", "node", "ours"),
