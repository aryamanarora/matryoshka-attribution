...
#
#   bash scripts/mib/launch/submit_dcm_lr.sh                    # 3 cells x 5 lrs x 3 densities = 45 jobs
#   LRS="3.0" bash scripts/mib/launch/submit_dcm_lr.sh          # add a point
#   DENSITIES="0.05" bash scripts/mib/launch/submit_dcm_lr.sh   # one pin only
#   DRYRUN=1 bash scripts/mib/launch/submit_dcm_lr.sh
#
