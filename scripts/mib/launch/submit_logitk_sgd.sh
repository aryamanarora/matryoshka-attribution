...
#   1. --lr goes on the command line (scripts/mib/launch/mib_node_seed.sbatch drops a 9th positional arg).
...
$pp$py scripts/mib/eval_mib.py --model $model --task $task --steps 500 --k-schedule logit \
