...
#
#   bash scripts/mib/launch/reeval_bern_gemma.sh              # submit (auto-detects running trainers)
#   DRYRUN=1 bash scripts/mib/launch/reeval_bern_gemma.sh     # preview
set -u
...
PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True $MIBV scripts/mib/reeval_mib_accauc.py \
