...
#
#  1. It passes --lr on the command line rather than going through scripts/mib/launch/mib_node_seed.sbatch.
...
$pp$py scripts/mib/eval_mib.py --model $model --task $task --steps 500 --k-schedule log \
