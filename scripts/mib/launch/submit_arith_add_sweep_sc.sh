...
#
# Training jobs go to large-memory h100 (node-level llama3 mask training, like the DBM ladder); the
# eval-only jobs fit a6000. Cells with a validation pkl are skipped.
...
TRAIN_RES="-q gpu-big -d h100 -r 128G"; EVAL_RES="-q gpu -d a6000 -c 4 -r 96G"
n=0; skip=0
