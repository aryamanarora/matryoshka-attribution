...
# cells answer for ~2.
#
#   bash scripts/mib/launch/submit_sigmoid_mask_lr.sh            # 3 cells x 3 lrs = 9 jobs
#   LRS="0.5" bash scripts/mib/launch/submit_sigmoid_mask_lr.sh  # add a point
#   DRYRUN=1 bash scripts/mib/launch/submit_sigmoid_mask_lr.sh
#
