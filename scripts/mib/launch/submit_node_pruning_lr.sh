...
#
#   bash scripts/mib/launch/submit_node_pruning_lr.sh            # submit all 88
#   bash scripts/mib/launch/submit_node_pruning_lr.sh 0.5        # just one budget
#   DRYRUN=1 bash scripts/mib/launch/submit_node_pruning_lr.sh   # preview
#
