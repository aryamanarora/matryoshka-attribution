...
as toy_linear_mattr, so plots/plot_toy_linear_convrate_facet.py bilinear reads it.
Regenerate: uv run python scripts/toy/toy_bilinear.py --method mattr --k_schedule uniform ...
"""
...
sys.path.insert(0, str(Path(__file__).resolve().parents[2] / "plots"))  # toy_linear_mattr lives in plots/
