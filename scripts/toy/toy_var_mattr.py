...
n up to 64. Same convergence test as the other toys.
  ...
  uv run python scripts/toy/toy_var_mattr.py --method uniform
  uv run python scripts/toy/toy_var_mattr.py --method log
  uv run python scripts/toy/toy_var_mattr.py --method ixg
"""
