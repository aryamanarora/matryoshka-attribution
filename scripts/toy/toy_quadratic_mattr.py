...
n up to 64 only (N up to 2144). Same convergence test as the linear toy.
  ...
  uv run python scripts/toy/toy_quadratic_mattr.py --method uniform
  uv run python scripts/toy/toy_quadratic_mattr.py --method log
  uv run python scripts/toy/toy_quadratic_mattr.py --method ixg
"""
